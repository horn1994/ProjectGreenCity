...
from data_processing import gdf_zold, gdf_erdo, gdf_erdopoint,gdf_combined, gdf_combined_filtered, gdf_all, gdf_aggregated, gdf_combined_aggregated, gdf_combined_aggregated_filtered
...
figure1.update_layout(
    title={'text':"Látogatók számának előző napi és átlagos előző heti óránkénti eloszlása",'y':1,
        'x':0.5,
           'xanchor': 'center'},
...
def update_map(value):
	if (value is None) or (value == "Válassz egy parkot"):
		...
		gjson_erdopoint = folium.GeoJson(gdf_combined_aggregated,style_function_zold, tooltip =tooltip_zold).add_to(bp_map)
